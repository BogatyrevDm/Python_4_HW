...
def check_2(lst_obj):
    ...
    """
    for j in range(len(lst_obj)):          # O(len(lst_obj)) линейная сложность. Зависит от длины переданной структуры
        if lst_obj[j] in lst_obj[j+1:]:    # O(len(lst_obj)) линейная сложность. Зависит от длины переданной структуры
            return False                   # O(1)
    return True                            # O(1)
...
def check_3(lst_obj):
    ...
    for i in range(len(lst_obj) - 1):        # O(len(lst_obj)) линейная сложность. Зависит от длины переданной структуры
